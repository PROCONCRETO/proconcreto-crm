...
- Solo llena: Razón social, NIT, Dirección, Correo de facturación, Régimen tributario. **Nunca** toca Contacto/Celular/Email — esos son datos de la persona operativa de contacto, que el RUT no tiene y siguen siendo manuales. (El representante legal del RUT se evaluó pero no se incluyó — no hace falta para este flujo.)
